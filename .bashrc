...
alias :q="exit" # expertproof
alias vi="vim" # expertproof
alias tmux="(tmux has-session && tmux attach) || tmux -2" # 2: 256 colors; Attach to an existing session, or make a new one.
alias ..="cd .."
alias ...="cd ../.."
alias ~="cd ~"
alias rm="rm -r"
